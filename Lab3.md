...
Males have a higher RSE. Females have a higher SWL. The relationship
between RSE and SWL is stronger for Males than Females.
...
![](Lab3_files/figure-gfm/unnamed-chunk-7-2.png)<!-- -->
...
You can see the general distribution of scores as an overview, the mode,
and range. You cannot tell individual scores. You can only make
inferences about the general relationship between the variables. For
example, men show greater RSE scores than women but both are similar in
SWL (given similarly shaped violin plots).
